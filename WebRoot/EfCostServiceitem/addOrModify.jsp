...
<% 
	...
	// 对象实例 
	EfCostServiceitemObj domainInstance = new EfCostServiceitemObj(); 
	// 该功能基本路径 
	...
	{ 
		domainInstance = (EfCostServiceitemObj) domainInstanceObj; 
	} 
 
	// 是否是修改 
	boolean isModify = domainInstance.getKeyValue() > 0; 
	// 唯一性检查用的字段 
	String keyCol = "cserviceitemcode"; 
%> 
<html> 
	<head> 
		<base target="_self" /> 
		...
		if(!checkNull("cserviceitemcode","<%=domainInstance.getPropertyCnName("cserviceitemcode")%>")) return false; 
		if(!checkNull("cserviceitemname","<%=domainInstance.getPropertyCnName("cserviceitemname")%>")) return false; 
		if(!checkNull("iserviceweight","<%=domainInstance.getPropertyCnName("iserviceweight")%>")) return false; 
		...
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/<%=basePath%>/Servlet?method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
				...
				<tr> 
					...
					<td> 
						<input name="cserviceitemcode" type="text" id="cserviceitemcode" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCserviceitemcode(),"")%>" size="20"  <%=isModify?"readOnly":""%>> 
						<font color="red">*</font> 
				...
				<tr> 
					...
					<td> 
						<input name="cserviceitemname" type="text" id="cserviceitemname" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCserviceitemname(),"")%>" size="20"  > 
						<font color="red">*</font> 
					</td> 
				</tr> 
				<tr> 
					...
					<td> 
						<input name="iserviceweight" type="text" id="iserviceweight" value="<%=StringUtil.getNotEmptyStr(domainInstance.getIserviceweight(),"")%>" size="20"  > 
						<font color="red">*</font> 
					</td> 
				</tr> 
				<tr> 
					...
					<td> 
						<%=DictionaryUtil.getSelectHtml(new DictionaryService().getDictItemsByDictName("核算科室字典", false), "cdeptcode", "", StringUtil.getNotEmptyStr(domainInstance.getCdeptcode(), ""), "notEmpty")%> 
						<font color="red">*</font> 
					</td> 
				</tr> 
			</table> 
