			...
			<table class="search_table" align="center" width="98%"> 
				<tr> 
					<td align="left"> 
						...
						<input name="cchargeitemcode" type="text" id="cchargeitemcode" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCchargeitemcode())%>" size="20" > 
						&nbsp;  
						<%=domainInstance.getPropertyCnName("cchargeitemname") %> 
						<input name="cchargeitemname" type="text" id="cchargeitemname" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCchargeitemname())%>" size="20" > 
						&nbsp;  
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						...
						<th><%=domainInstance.getPropertyCnName("cchargeitemcode") %></th> 
						<th><%=domainInstance.getPropertyCnName("cchargeitemname") %></th> 
						<th><%=domainInstance.getPropertyCnName("cchargekindcode") %></th> 
						<th><%=domainInstance.getPropertyCnName("coutitemcode") %></th> 
						<th><%=domainInstance.getPropertyCnName("cinitemcode") %></th> 
				...
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							EfCostChargeitemObj o = (EfCostChargeitemObj) list.get(i); 
				%> 
				<tr> 
					<td> 
					...
					<td><%=StringUtil.getNotEmptyStr(o.getCchargeitemcode())%></td> 
					<td><%=StringUtil.getNotEmptyStr(o.getCchargeitemname())%></td> 
					<td><%=new DictionaryService().getDictValueByDictKey("收费类别字典",o.getCchargekindcode())%></td> 
					<td><%=StringUtil.getNotEmptyStr(o.getCoutitemcode())%></td> 
					<td><%=StringUtil.getNotEmptyStr(o.getCinitemcode())%></td> 
