...
<%@page import="com.cost.obj.EfCostWbsourceObj"%> 
<!-- 基本信息 --> 
<% 
	// 当前上下文路径 
	...
	// 该功能对象实例 
	EfCostWbsourceObj domainInstance = (EfCostWbsourceObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
			...
			<table class="search_table" align="center" width="98%"> 
				<tr> 
					<td align="left"> 
						...
						&nbsp;  
						<%=domainInstance.getPropertyCnName("cname") %> 
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						...
						<th><%=domainInstance.getPropertyCnName("cname") %></th> 
						<th><%=domainInstance.getPropertyCnName("debitORcredit") %></th> 
						<th>对照关系维护</th> 
						<th>操作</th> 
					</tr> 
				</thead> 
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							EfCostWbsourceObj o = (EfCostWbsourceObj) list.get(i); 
				%> 
				<tr> 
					<td> 
