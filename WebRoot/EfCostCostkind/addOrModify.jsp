...
<% 
	...
	// 对象实例 
	EfCostCostkindObj domainInstance = new EfCostCostkindObj(); 
	// 该功能基本路径 
	...
	{ 
		domainInstance = (EfCostCostkindObj) domainInstanceObj; 
	} 
 
	// 是否是修改 
	boolean isModify = domainInstance.getKeyValue() > 0; 
	// 唯一性检查用的字段 
	String keyCol = "ccostkindcode"; 
%> 
<html> 
	<head> 
		<base target="_self" /> 
		...
		if(!checkNull("ccostkindname","<%=domainInstance.getPropertyCnName("ccostkindname")%>")) return false; 
		...
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/<%=basePath%>/Servlet?method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
				...
				<tr> 
					...
					<td> 
						<input name="ccostkindcode" type="text" id="ccostkindcode" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCcostkindcode(),"")%>" size="20"  <%=isModify?"readOnly":""%>> 
						<font color="red">*</font> 
