...
<%@page import="com.cost.obj.EfCostCostkindObj"%> 
<!-- 基本信息 --> 
<% 
	// 当前上下文路径 
	...
	// 该功能对象实例 
	EfCostCostkindObj domainInstance = (EfCostCostkindObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
			...
			<table class="search_table" align="center" width="98%"> 
				<tr> 
					<td align="left"> 
						...
						<input name="ccostkindcode" type="text" id="ccostkindcode" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCcostkindcode())%>" size="20" > 
						&nbsp;  
						<%=domainInstance.getPropertyCnName("ccostkindname") %> 
						<input name="ccostkindname" type="text" id="ccostkindname" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCcostkindname())%>" size="20" > 
						&nbsp;  
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						...
						<th><%=domainInstance.getPropertyCnName("ccostkindname") %></th> 
						<th>操作</th> 
					</tr> 
				</thead> 
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							EfCostCostkindObj o = (EfCostCostkindObj) list.get(i); 
				%> 
				<tr> 
					<td> 
					...
					<td><%=StringUtil.getNotEmptyStr(o.getCcostkindcode())%></td> 
					<td><%=StringUtil.getNotEmptyStr(o.getCcostkindname())%></td> 
