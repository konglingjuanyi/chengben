...
<%@page import="com.chengben.obj.CostShareRuleObj"%> 
<% 
	// 当前上下文路径  
	String contextPath = request.getContextPath();  
  
	// 该功能对象实例  
	CostShareRuleObj domainInstance = (CostShareRuleObj) request.getAttribute("domainInstance");  
	// 该功能路径  
	...
	<body> 
		...
		<table width="600" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
			...
			<tr> 
				...
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getShare_rate_level_1())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("share_rate_level_2") %>: 
				</td> 
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getShare_rate_level_2())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("share_rate_level_3") %>: 
				</td> 
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getShare_rate_level_3())%></td> 
			</tr> 
		</table> 
