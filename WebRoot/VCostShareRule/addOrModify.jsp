...
<% 
	...
	{ 
		domainInstance = (VCostShareRuleObj) domainInstanceObj; 
	} 
...
<html> 
	<head> 
		...
		if(!checkNull("share_rate_level_1","<%=domainInstance.getPropertyCnName("share_rate_level_1")%>")) return false; 
	...
	<body> 
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/<%=basePath%>/Servlet?method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
				...
				<tr> 
					<td> 
						<%=domainInstance.getPropertyCnName("share_rate_level_1") %>: 
					</td> 
					<td> 
						<input name="share_rate_level_1" type="text" id="share_rate_level_1" value="<%=StringUtil.getNotEmptyStr(domainInstance.getShare_rate_level_1(),"")%>" size="20"  > 
						<font color="red">*</font> 
					</td> 
				</tr> 
				<tr> 
					<td> 
						<%=domainInstance.getPropertyCnName("share_rate_level_2") %>: 
					</td> 
					<td> 
						<input name="share_rate_level_2" type="text" id="share_rate_level_2" value="<%=StringUtil.getNotEmptyStr(domainInstance.getShare_rate_level_2(),"")%>" size="20"  > 
					</td> 
				</tr> 
				<tr> 
					<td> 
						<%=domainInstance.getPropertyCnName("share_rate_level_3") %>: 
					</td> 
					<td> 
						<input name="share_rate_level_3" type="text" id="share_rate_level_3" value="<%=StringUtil.getNotEmptyStr(domainInstance.getShare_rate_level_3(),"")%>" size="20"  > 
					</td> 
				</tr> 
			</table> 
