...
<% 
	...
	// 对象实例 
	EfCostSharefunObj domainInstance = new EfCostSharefunObj(); 
	// 该功能基本路径 
	...
	{ 
		domainInstance = (EfCostSharefunObj) domainInstanceObj; 
	} 
...
<html> 
	<head> 
		...
		if(!checkNull("csharefun","<%=domainInstance.getPropertyCnName("csharefun")%>")) return false; 
