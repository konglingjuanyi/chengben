...
<%@page import="com.cost.obj.EfCostSharefunObj"%> 
<!-- 基本信息 --> 
<% 
	// 当前上下文路径 
	...
	// 该功能对象实例 
	EfCostSharefunObj domainInstance = (EfCostSharefunObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
			...
			<table class="search_table" align="center" width="98%"> 
				<tr> 
					<td align="left"> 
						...
						&nbsp;  
						<%=domainInstance.getPropertyCnName("csharefun") %> 
						<%=DictionaryUtil.getSelectHtml(new DictionaryService().getDictItemsByDictName("分摊方法字典", false), "csharefun", "", StringUtil.getNotEmptyStr(domainInstance.getCsharefun(), ""), "notEmpty")%> 
						&nbsp;  
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						...
						<th><%=domainInstance.getPropertyCnName("csharefun") %></th> 
				...
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							EfCostSharefunObj o = (EfCostSharefunObj) list.get(i); 
				%> 
				<tr> 
					<td> 
					...
					<td><%=new DictionaryService().getDictValueByDictKey("核算科室字典",o.getCdeptcode())%></td>  
					<td><%=new DictionaryService().getDictValueByDictKey("分摊方法字典",o.getCsharefun())%></td>  
