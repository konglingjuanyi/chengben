	...
	<body> 
		...
		<table width="600" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
			<tr> 
				...
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getSource_system())%></td> 
			</tr> 
			<tr> 
				<td> 
			...
			<tr> 
				...
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getRelation_total_num())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("relation_ok_num") %>: 
				</td> 
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getRelation_ok_num())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("relation_not_ok_num") %>: 
				</td> 
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getRelation_not_ok_num())%></td> 
			</tr> 
		</table> 
