...
<% 
	...
	// 该功能对象实例 
	CostDirectObj domainInstance = (CostDirectObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				...
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							CostDirectObj o = (CostDirectObj) list.get(i); 
				%> 
				<tr> 
					<td> 
					...
					<td><%=StringUtil.getNotEmptyStr(o.getDate_month())%></td> 
