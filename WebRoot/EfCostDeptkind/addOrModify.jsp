...
<% 
	...
	// 对象实例 
	EfCostDeptkindObj domainInstance = new EfCostDeptkindObj(); 
	// 该功能基本路径 
	...
	{ 
		domainInstance = (EfCostDeptkindObj) domainInstanceObj; 
	} 
 
	// 是否是修改 
	boolean isModify = domainInstance.getKeyValue() > 0; 
	// 唯一性检查用的字段 
	String keyCol = "cdeptkindcode"; 
%> 
<html> 
	<head> 
		<base target="_self" /> 
		...
		if(!checkNull("cdeptkindname","<%=domainInstance.getPropertyCnName("cdeptkindname")%>")) return false; 
		...
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/<%=basePath%>/Servlet?method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
				...
				<tr> 
					...
					<td> 
						<input name="cdeptkindcode" type="text" id="cdeptkindcode" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCdeptkindcode(),"")%>" size="20"  <%=isModify?"readOnly":""%>> 
						<font color="red">*</font> 
