...
<%@page import="com.cost.obj.EfCostDeptkindObj"%> 
<!-- 基本信息 --> 
<% 
	// 当前上下文路径 
	...
	// 该功能对象实例 
	EfCostDeptkindObj domainInstance = (EfCostDeptkindObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
			...
			<table class="search_table" align="center" width="98%"> 
				<tr> 
					<td align="left"> 
						...
						<input name="cdeptkindcode" type="text" id="cdeptkindcode" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCdeptkindcode())%>" size="20" > 
						&nbsp;  
						<%=domainInstance.getPropertyCnName("cdeptkindname") %> 
						<input name="cdeptkindname" type="text" id="cdeptkindname" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCdeptkindname())%>" size="20" > 
						&nbsp;  
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						...
						<th><%=domainInstance.getPropertyCnName("cdeptkindname") %></th> 
						<th>操作</th> 
					</tr> 
				</thead> 
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							EfCostDeptkindObj o = (EfCostDeptkindObj) list.get(i); 
				%> 
				<tr> 
					<td> 
					...
					<td><%=StringUtil.getNotEmptyStr(o.getCdeptkindcode())%></td> 
					<td><%=StringUtil.getNotEmptyStr(o.getCdeptkindname())%></td> 
