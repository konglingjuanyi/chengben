			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						...
						<th><%=domainInstance.getPropertyCnName("shouru") %></th> 
						<th><%=domainInstance.getPropertyCnName("chuang_ri_chengben") %></th> 
						<th><%=domainInstance.getPropertyCnName("zhen_ci_chengben") %></th> 
						<th>操作</th> 
					</tr> 
				</thead> 
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							VDepartmentIncomeObj o = (VDepartmentIncomeObj) list.get(i); 
				%> 
				<tr> 
					...
					<td><%=StringUtil.getNotEmptyStr(o.getShouru())%></td> 
					<td><%=StringUtil.getNotEmptyStr(o.getChuang_ri_chengben())%></td> 
					<td><%=StringUtil.getNotEmptyStr(o.getZhen_ci_chengben())%></td> 
