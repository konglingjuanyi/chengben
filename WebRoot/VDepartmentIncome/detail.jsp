...
<% 
	...
	// 该功能对象实例  
	VDepartmentIncomeObj domainInstance = (VDepartmentIncomeObj) request.getAttribute("domainInstance");  
	// 该功能路径  
	...
	<body> 
		...
		<table width="600" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
			...
			<tr> 
				...
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getShouru())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("chuang_ri_chengben") %>: 
				</td> 
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getChuang_ri_chengben())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("zhen_ci_chengben") %>: 
				</td> 
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getZhen_ci_chengben())%></td> 
			</tr> 
		</table> 
