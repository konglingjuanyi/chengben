...
<% 
	...
	// 对象实例 
	EfCostSharelevelObj domainInstance = new EfCostSharelevelObj(); 
	// 该功能基本路径 
	...
	{ 
		domainInstance = (EfCostSharelevelObj) domainInstanceObj; 
	} 
 
	// 是否是修改 
	boolean isModify = domainInstance.getKeyValue() > 0; 
	// 唯一性检查用的字段 
	String keyCol = "csharelevelcode"; 
%> 
<html> 
	<head> 
		<base target="_self" /> 
		...
		if(!checkNull("csharelevelname","<%=domainInstance.getPropertyCnName("csharelevelname")%>")) return false; 
		...
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/<%=basePath%>/Servlet?method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
				...
				<tr> 
					...
					<td> 
						<input name="csharelevelcode" type="text" id="csharelevelcode" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCsharelevelcode(),"")%>" size="20"  <%=isModify?"readOnly":""%>> 
						<font color="red">*</font> 
