...
<%@page import="com.cost.obj.EfCostSharelevelObj"%> 
<!-- 基本信息 --> 
<% 
	// 当前上下文路径 
	...
	// 该功能对象实例 
	EfCostSharelevelObj domainInstance = (EfCostSharelevelObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
			...
			<table class="search_table" align="center" width="98%"> 
				<tr> 
					<td align="left"> 
						...
						<input name="csharelevelcode" type="text" id="csharelevelcode" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCsharelevelcode())%>" size="20" > 
						&nbsp;  
						<%=domainInstance.getPropertyCnName("csharelevelname") %> 
						<input name="csharelevelname" type="text" id="csharelevelname" value="<%=StringUtil.getNotEmptyStr(domainInstance.getCsharelevelname())%>" size="20" > 
						&nbsp;  
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						...
						<th><%=domainInstance.getPropertyCnName("csharelevelname") %></th> 
				...
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							EfCostSharelevelObj o = (EfCostSharelevelObj) list.get(i); 
				%> 
				<tr> 
					<td> 
					...
					<td><%=StringUtil.getNotEmptyStr(o.getCsharelevelcode())%></td> 
					<td><%=StringUtil.getNotEmptyStr(o.getCsharelevelname())%></td> 
