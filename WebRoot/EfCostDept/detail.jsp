	...
	<body> 
		...
		<table width="600" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
			...
			<tr> 
				...
				<td><%=StringUtil.getNotEmptyStr(domainInstance.getCdeptname())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("cparentcode") %>: 
				</td> 
				<td><%=new DictionaryService().getDictValueByDictKey("核算科室字典",domainInstance.getCparentcode())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("csharekindcode") %>: 
				</td> 
				<td><%=new DictionaryService().getDictValueByDictKey("分摊类别字典",domainInstance.getCsharekindcode())%></td> 
			</tr> 
			<tr> 
				<td> 
			...
			<tr> 
				...
				<td><%=new DictionaryService().getDictValueByDictKey("是否字典",domainInstance.getCvirtual())%></td> 
			</tr> 
			<tr> 
				<td> 
					<%=domainInstance.getPropertyCnName("igrade") %>: 
				</td> 
				<td><%=new DictionaryService().getDictValueByDictKey("级次字典",domainInstance.getIgrade())%></td> 
			</tr> 
			<tr> 
				<td> 
			...
			<tr> 
				...
				<td><%=new DictionaryService().getDictValueByDictKey("是否字典",domainInstance.getCksstop())%></td> 
			</tr> 
		</table> 
