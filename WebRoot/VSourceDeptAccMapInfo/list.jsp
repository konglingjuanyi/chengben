...
<%@page import="com.chengben.obj.VSourceDeptAccMapInfoObj"%> 
<!-- 基本信息 --> 
<% 
	// 当前上下文路径 
	...
	// 该功能对象实例 
	VSourceDeptAccMapInfoObj domainInstance = (VSourceDeptAccMapInfoObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				...
				<% 
					for (int i = 0; i < list.size(); i++) 
						{ 
							VSourceDeptAccMapInfoObj o = (VSourceDeptAccMapInfoObj) list.get(i); 
				%> 
				<tr> 
					...
					<a href="#" onclick="winOpen('<%=request.getContextPath()%>/SourceDeptAccMap/Servlet?method=list4this&list4notOk=true&source_system=<%=o.getSource_system() %>')"><%=StringUtil.getNotEmptyStr(o.getRelation_not_ok_num())%></a>
					<%} else { %>
					0
					<%}%>
					</td>
					<td align="left" style="cursor: pointer"> 
						<a href="#" onclick="winOpen('<%=request.getContextPath()%>/SourceDeptAccMap/Servlet?method=list4this&source_system=<%=o.getSource_system() %>')">维护</a>
					</td> 
				</tr> 
				<% 
					} 
