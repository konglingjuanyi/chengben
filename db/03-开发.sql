...
r.department_code,
r.department_name,
isnull(cd.renyuan_jingfei,0) renyuan_jingfei,
isnull(cd.weisheng_cailiao,0) weisheng_cailiao,
isnull(cd.yaopin,0) yaopin,
isnull(cd.guding_zichan_zhejiu,0) guding_zichan_zhejiu,
isnull(cd.wuxing_zichan_tanxiao,0) wuxing_zichan_tanxiao,
isnull(cd.tiqu_yiliao_fengxian_jijin,0) tiqu_yiliao_fengxian_jijin,
isnull(cd.qita_feiyong,0) qita_feiyong,
...
isnull(r.share_rate_level_1*cd_sum.renyuan_jingfei/100,0)	renyuan_jingfei_l1,
isnull(r.share_rate_level_1*cd_sum.weisheng_cailiao/100,0)	weisheng_cailiao_l1,
isnull(r.share_rate_level_1*cd_sum.yaopin/100,0)	yaopin_l1,
isnull(r.share_rate_level_1*cd_sum.guding_zichan_zhejiu/100,0)	guding_zichan_zhejiu_l1,
isnull(r.share_rate_level_1*cd_sum.wuxing_zichan_tanxiao/100,0)	wuxing_zichan_tanxiao_l1,
isnull(r.share_rate_level_1*cd_sum.tiqu_yiliao_fengxian_jijin/100,0)	tiqu_yiliao_fengxian_jijin_l1,
isnull(r.share_rate_level_1*cd_sum.qita_feiyong/100,0)	qita_feiyong_l1,
isnull(r.share_rate_level_1*cd_sum.heji/100,0)	heji_l1 
from 
cost_share_rule r
left join
cost_direct cd
...
(renyuan_jingfei_sum+weisheng_cailiao_sum+yaopin_sum+guding_zichan_zhejiu_sum+wuxing_zichan_tanxiao_sum+tiqu_yiliao_fengxian_jijin_sum+qita_feiyong_sum+0.00001) total
from
(
select 
c.date_month,
...
c.department_code,
c.department_name,
isnull(c.renyuan_jingfei,0) renyuan_jingfei,(l3.renyuan_jingfei_l3_sum-isnull(c.renyuan_jingfei,0)) renyuan_jingfei_share,l3.renyuan_jingfei_l3_sum renyuan_jingfei_sum,
isnull(c.weisheng_cailiao,0) weisheng_cailiao,(weisheng_cailiao_l3_sum-isnull(c.weisheng_cailiao,0)) weisheng_cailiao_share,l3.weisheng_cailiao_l3_sum weisheng_cailiao_sum,
isnull(c.yaopin,0) yaopin,(yaopin_l3_sum-isnull(c.yaopin,0)) yaopin_share,l3.yaopin_l3_sum yaopin_sum,
isnull(c.guding_zichan_zhejiu,0) guding_zichan_zhejiu,(guding_zichan_zhejiu_l3_sum-isnull(c.guding_zichan_zhejiu,0)) guding_zichan_zhejiu_share,l3.guding_zichan_zhejiu_l3_sum guding_zichan_zhejiu_sum,
isnull(c.wuxing_zichan_tanxiao,0) wuxing_zichan_tanxiao,(wuxing_zichan_tanxiao_l3_sum-isnull(c.wuxing_zichan_tanxiao,0)) wuxing_zichan_tanxiao_share,l3.wuxing_zichan_tanxiao_l3_sum wuxing_zichan_tanxiao_sum,
isnull(c.tiqu_yiliao_fengxian_jijin,0) tiqu_yiliao_fengxian_jijin,(tiqu_yiliao_fengxian_jijin_l3_sum-isnull(c.tiqu_yiliao_fengxian_jijin,0)) tiqu_yiliao_fengxian_jijin_share,l3.tiqu_yiliao_fengxian_jijin_l3_sum tiqu_yiliao_fengxian_jijin_sum,
isnull(c.qita_feiyong,0) qita_feiyong,(qita_feiyong_l3_sum-isnull(c.qita_feiyong,0)) qita_feiyong_share,l3.qita_feiyong_l3_sum qita_feiyong_sum,
isnull(c.heji,0) heji,(heji_l3_sum-isnull(c.heji,0)) heji_share,l3.heji_l3_sum heji_sum,
r.income,
r.cost_per_bed,
r.cost_per_treat
from cost_direct c
