...
public class VCostDirectSumbyDepttypeObj extends BaseDbObj
{
...
{
	return "v_cost_direct_sumby_depttype";
}
@Override 
...
{
	return "VCostDirectSumbyDepttype";
}
@Override
